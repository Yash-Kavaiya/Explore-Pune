...
import {
  ...
  PALACE_STATS,
  PALACE_STORY,
} from "@/lib/data/aga-khan-palace";

/**
 * Editorial half of the Aga Khan Palace page — the history and features the 3D
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="mt-4 text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              A graceful palace, a heavy chapter
            </h2>
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                Built as an act of charity in 1892, it became a place of national memory in 1942 —
                and has carried both ever since.
              </blockquote>
            </figure>
          </div>

          <div className="space-y-10">
            {PALACE_STORY.map((block) => (
