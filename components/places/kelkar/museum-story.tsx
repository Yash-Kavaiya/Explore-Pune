...
import {
  ...
  MUSEUM_STATS,
  MUSEUM_STORY,
} from "@/lib/data/kelkar-museum";

/**
 * Editorial half of the Kelkar Museum page — the history and features the 3D
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="mt-4 text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              Twenty thousand ordinary beautiful things
            </h2>
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                Not royal jewels, but lamps, cutters, doors and instruments — craft elevated by the
                skill of the hand that made them.
              </blockquote>
            </figure>
          </div>

          <div className="space-y-10">
            {MUSEUM_STORY.map((block) => (
