...
import {
  ...
  HILL_STATS,
  HILL_STORY,
} from "@/lib/data/vetal-tekdi";

/**
 * Editorial half of the Vetal Tekdi page — the history and features
 * the 3D model can show but not explain. Feature cards match the scene markers.
 */
export function HillStory() {
  return (
    <>
          ...
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                No gates, no tickets, no closing hour. The commons at the heart of the city — and
                Pune shows up for it.
              </blockquote>
            </figure>
          </div>

          <div className="space-y-10">
            {HILL_STORY.map((block) => (
