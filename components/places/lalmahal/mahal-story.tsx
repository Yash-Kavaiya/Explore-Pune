...
import {
  ...
  LAL_MAHAL_STATS,
  LAL_MAHAL_STORY,
} from "@/lib/data/lal-mahal";

/**
 * Editorial half of the Lal Mahal page — history and features the 3D model can
 * show but not explain. Feature cards match the scene markers.
 */
export function MahalStory() {
  return (
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="mt-4 text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              A modest red house, a heavy childhood
            </h2>
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                Built for Jijabai and young Shivaji around 1630, remembered for a night raid that
                still defines Maratha legend.
              </blockquote>
            </figure>
          </div>

          <div className="space-y-10">
            {LAL_MAHAL_STORY.map((block) => (
