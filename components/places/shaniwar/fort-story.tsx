import { Castle, Quote } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import {
  ...
  FORT_STATS,
  FORT_STORY,
} from "@/lib/data/shaniwar-wada";

/**
 * Editorial half of the Shaniwar Wada page — the history and features the 3D
 * model can show but not explain. Feature cards match the scene markers.
 */
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="mt-4 text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              The palace that burned, the fort that stayed
            </h2>
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                What you walk across today is the outline: floor levels, doorway thresholds and the
                stumps of columns, laid out like a plan drawing at full size.
              </blockquote>
            </figure>
          </div>

          <div className="space-y-10">
            {FORT_STORY.map((block) => (
