...
import {
  ...
  GARDEN_STATS,
  GARDEN_STORY,
} from "@/lib/data/okayama-garden";

/**
 * The editorial half of the Okayama page — everything the 3D model can show
 * you but not explain. Feature cards are numbered to match the scene markers.
 */
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="mt-4 text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              A Japanese garden with a Marathi name
            </h2>
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                A stroll garden is designed to be walked, not looked at. It hides the pond so it can
                give it back to you.
              </blockquote>
            </figure>
          </div>
...
/** Etiquette + FAQ — rendered lower down, beside the practical details. */
export function GardenEtiquette() {
  return (
    <div className="rounded-2xl border border-border/70 bg-card p-6">
      <h3 className="font-heading text-lg font-semibold">Garden etiquette</h3>
      <ul className="mt-4 space-y-3">
        {GARDEN_ETIQUETTE.map((rule) => (
