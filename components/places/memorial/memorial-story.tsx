...
import {
  ...
  MEMORIAL_STATS,
  MEMORIAL_STORY,
} from "@/lib/data/national-war-memorial";

/**
 * Editorial half of the National War Memorial page — the history and features
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="mt-4 text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              A citizens&apos; memorial for the Southern Command
            </h2>
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                The only war memorial in South Asia raised by the people who live beside it —
                a 25-metre column, a flame, and the hardware of three services on a Ghorpadi lawn.
              </blockquote>
            </figure>
          </div>

          <div className="space-y-10">
            {MEMORIAL_STORY.map((block) => (
