...
import {
  ...
  SINHAGAD_STATS,
  SINHAGAD_STORY,
} from "@/lib/data/sinhagad-fort";

export function SinhagadStory() {
  return (
    <>
          ...
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                He gained a fort and lost a lion — Kondhana became Sinhagad after Tanaji Malusare&apos;s
                1670 assault.
              </blockquote>
            </figure>
          </div>
