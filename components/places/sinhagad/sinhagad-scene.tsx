...
export type SinhagadSceneProps = {
...
export default function SinhagadScene({
  active,
  timeOfDay,
  season,
  onSelect,
  ...
  const worldRef = React.useRef<SinhagadWorld | null>(null);
  ...
  React.useEffect(() => {
    ...
    let world: SinhagadWorld;
    try {
      world = createSinhagadWorld(mount, {
        reducedMotion,
