...
import {
  ...
  EMPRESS_STATS,
  EMPRESS_STORY,
} from "@/lib/data/empress-garden";

export function EmpressStory() {
  return (
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="mt-4 text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
              Camp&apos;s 39-acre horticultural park
            </h2>
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                Named for an empress, run by a horticultural society, and still the place Pune
                goes when it wants to look at roses under old trees.
              </blockquote>
            </figure>
          </div>
          <div className="space-y-10">
            {EMPRESS_STORY.map((block) => (
              <div key={block.heading}>
                <h3 className="font-heading text-xl font-semibold tracking-tight">{block.heading}</h3>
