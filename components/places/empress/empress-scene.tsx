...
export default function EmpressScene({
  active,
  timeOfDay,
  mode,
  onSelect,
  ...
  const worldRef = React.useRef<EmpressWorld | null>(null);
  ...
  React.useEffect(() => {
    ...
    let world: EmpressWorld;
    try {
      world = createEmpressWorld(mount, {
        reducedMotion,
