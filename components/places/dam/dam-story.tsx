...
import {
  ...
  DAM_STATS,
  DAM_STORY,
} from "@/lib/data/khadakwasla-dam";

export function DamStory() {
  return (
    <>
          ...
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <figure className="mt-6 border-l-2 border-primary/40 pl-4">
              ...
              <blockquote className="mt-2 text-sm italic leading-relaxed text-muted-foreground">
                A wall you walk, a lake the city drinks from, and Sinhagad sitting on the ridge
                as if it were part of the dam.
              </blockquote>
            </figure>
          </div>
